    ...
    final faults = switch (scenarioId) {
      ...
      'cameraLost' => [
          const FaultData(
            ...
            countermeasures: ['Localization: NDT LiDAR + GNSS', 'Planning: lanelet route 유지', 'Control: speed cap 45km/h'],
          ),
        ],
      'gnssDenied' => [
          const FaultData(
            ...
            countermeasures: ['Localization: LiDAR odometry + visual lane', 'Planning: local map confidence', 'Control: lateral smoothing'],
          ),
        ],
      'lidarDegraded' => [
          const FaultData(
            ...
            countermeasures: ['Localization: GNSS + camera lane', 'Perception: radar fallback', 'Control: speed cap 35km/h'],
          ),
        ],
      'lidarFrontLeft' => [
          const FaultData(
            ...
            countermeasures: ['Reduce left point-cloud confidence', 'Keep NDT with remaining LiDARs', 'No left lane change'],
          ),
        ],
      'lidarFrontCenter' => [
          const FaultData(
            ...
            countermeasures: ['Split front LiDAR fusion', 'Increase camera lane weight', 'Speed cap 35km/h'],
          ),
        ],
      'lidarFrontRight' => [
          const FaultData(
            ...
            countermeasures: ['Reduce right point-cloud confidence', 'Keep NDT with remaining LiDARs', 'No right lane change'],
          ),
        ],
      'lidarRearCenter' => [
          const FaultData(
            ...
            countermeasures: ['Rear object confidence down', 'Disable reverse assist', 'MRM standby'],
          ),
        ],
      'gnssDrift' => [
          const FaultData(
            ...
            countermeasures: ['GNSS fusion weight 0', 'LiDAR + Camera localization', 'Localization discontinuity check'],
          ),
        ],
      'gnssOnly' => [
          const FaultData(
            ...
            countermeasures: ['GNSS hold', 'No autonomous lane change', 'Prepare MRM safe stop'],
          ),
          const FaultData(
            id: 93,
            target: 'FrontCenterCamera',
            ...
            countermeasures: ['Disable visual lane localization', 'Reduce control authority'],
          ),
        ],
      'tsnSyncLost' => [
          const FaultData(
            ...
            countermeasures: ['BMCA failover', 'FRER redundant path', 'DetNet jitter validation'],
          ),
        ],
      'frerPathLost' => [
          const FaultData(
            ...
            countermeasures: ['Path B active', 'Hitless recovery check', 'Latency max validation'],
          ),
        ],
      'zgFrontIsolated' => [
          const FaultData(
            ...
            countermeasures: ['Route sensors through backup gateway', 'Camera/LiDAR confidence down', 'MRM standby'],
          ),
        ],
      'localizationDelayed' => [
          const FaultData(
            ...
            countermeasures: ['Resource scheduling', 'Pipeline watchdog', 'Mode switch time validation'],
          ),
        ],
      'compoundRain' => [
          const FaultData(
          ...
          const FaultData(
            ...
            countermeasures: ['Perception confidence monitor', 'MRM condition check'],
          ),
        ],
      'singleLidar' => [
          const FaultData(
            ...
            countermeasures: ['Localization: LiDAR NDT only', 'Planning: nearest safe lane', 'Control: crawl mode'],
          ),
          const FaultData(
            id: 62,
            target: 'TCU',
      ...
      'cameraOnly' => [
          const FaultData(
            ...
            countermeasures: ['Localization: visual lane only', 'Planning: lane keep only', 'Control: speed cap 15km/h'],
          ),
          const FaultData(
            id: 72,
            target: 'TCU',
      ...
      'mrmStop' => [
          const FaultData(
            ...
            countermeasures: ['Autoware MRM behavior 실행', 'Hazard signal', 'Safe stop trajectory'],
          ),
          const FaultData(
            id: 52,
            target: 'FrontCenterLidar',
